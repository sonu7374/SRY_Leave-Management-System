@php
    ...
    $infos = Auth::user();
    $leaveBalances = LeaveBalance::with('leaveType')->where('user_id', $infos->id)->where('year', now()->year)->get();
@endphp
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    ...
                    @if ($leaveBalances && count($leaveBalances) > 0)
                        <div class="card mt-4">
                            <div class="card-header">
                                <h5 class="mb-0">Leave Balance ({{ now()->year }})</h5>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($leaveBalances as $balance)
                                            <tr>
                                                ...
                                                <td>{{ $balance->used }}</td>
                                                <td>{{ $balance->allocated - $balance->used }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
